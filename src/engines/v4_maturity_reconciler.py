...
def reconcile(health: dict | None = None) -> dict:
    ...
    health["maturity_reconciliation"] = {
        ...
        "note": "Capability readiness is recomputed from concrete producer-consumer evidence; current optional external evidence remains a separate evidence-state dimension.",
    }
