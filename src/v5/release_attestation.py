...
def release_attestation() -> dict[str, Any]:
    ...
    payload={"contract":cfg.get("contract"),"v5_version":V5_VERSION,"production_baseline_version":baseline.get("production_truth"),"production_main_sha":production_source_sha(),"runtime_release_fingerprint":release.get("fingerprint")}
