...
def test_tactical_overlay_can_reach_sixth_close_canonical_alternative():
    # Regression for real-shadow cycle 67: production V3 considers six canonical
    # close alternatives. V5 previously published only three, making a legal
    # tactical winner unreachable even though it was inside the close-call gap.
    players = [
        _player(1, "GK", (0, 1, 1)),
