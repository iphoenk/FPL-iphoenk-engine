...
from src.engines.v4_decision_arbitration import SEVERITY, resolve_decision, validate_resolution
...
def govern_checkpoint(latest,health,sanity,lineup,locked,scorecard=None,now=None,actions=None,canonical=None,effective_plan=None,team=None,tactical=None,prices=None,competitive=None):
    ...
    team_for_resolution=team or {};prices_for_resolution=prices or {};tactical_for_resolution=tactical or {}
    canonical=canonical or read_json(DATA/"decision_arbitration_v4.json",{})
    if not canonical.get("resolution_id"):
        canonical=resolve_decision(sanity,lineup,latest,team_for_resolution,prices_for_resolution,tactical_for_resolution,now=evaluated_at)
    blockers=[]
