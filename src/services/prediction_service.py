...
def run() -> dict:
    ...
    latest = {
        ...
        "live_summary": {
            ...
            "gross_points": live_payload.get("gross_points"),
        ...
        "meta": {
            ...
            "parallel_fetch_is_single_snapshot_not_polling": True,
            "checkpoint_policy_registry_driven": True,
            "simulation_never_authorizes_action": True,
            "service_contract_compatible": True,
