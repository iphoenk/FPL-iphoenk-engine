...
from ..publication.store import ROOT

EVIDENCE_CONFIG = ROOT / "config" / "v6" / "identity_evidence_sources.json"
    ...
    for source_id in _EXPECTED_SOURCES:
        ...
        if source_id == "opta_the_analyst":
            observed = {
                ...
                "observed_join_eligible_player_count": canonical_count,
                "observed_join_coverage_ratio": canonical["canonical_coverage_ratio"],
                "provider_max_observed_join_coverage_ratio": canonical["canonical_coverage_ratio"],
                ...
                "reviewed_provider_limitation_native_ids": [],
                ...
                "provider_native_classification_counts": {
                    ...
                    "ACTIONABLE_UNMAPPED": max(0, canonical_count - canonical["canonical_mapped_player_count"]),
