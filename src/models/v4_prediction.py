...
POS={1:"GK",2:"DEF",3:"MID",4:"FWD"}; GOAL_PTS={1:6,2:6,3:5,4:4}; CS_PTS={1:4,2:4,3:1,4:0}; XG_PRIOR={1:0.01,2:0.06,3:0.18,4:0.30}; XA_PRIOR={1:0.005,2:0.08,3:0.16,4:0.11}; DEF_ACTION_PRIOR={1:1.0,2:7.0,3:6.0,4:3.0}; GK_SAVE_PRIOR=2.7
...
def lineup_distribution(p,ctx=None):
 ...
 # One confirmed 80-90 minute start should already imply strong, not merely coin-flip, next-GW security.
...
def goalkeeper_save_points(saves90,em):
 # FPL awards one point per complete block of three saves. A linear saves/3 expectation overstates thresholded returns.
