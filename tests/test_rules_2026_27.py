...
def test_match_scoring_reconstruction_goalkeeper():
    stats = {"minutes":90,"goals_scored":1,"assists":0,"clean_sheets":1,"goals_conceded":0,"saves":6,"penalties_saved":1,"penalties_missed":0,"yellow_cards":0,"red_cards":0,"own_goals":0,"bonus":3}
...
def test_match_scoring_reconstruction_defender_dc():
    stats = {"minutes":90,"goals_scored":0,"assists":1,"clean_sheets":1,"goals_conceded":0,"penalties_saved":0,"penalties_missed":0,"yellow_cards":0,"red_cards":0,"own_goals":0,"bonus":2,"defensive_contribution":10}
