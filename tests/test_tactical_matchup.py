    ...
    artifacts = {
        "team_profiles": {
            "teams": {
                ...
                "2": {"coach": "Coach B", "base_formation": "4-4-2", "pressing": "high press", "vulnerabilities": ["central pocket"]},
            }
        },
        "recent_form": {"teams": {"2": [{"gw": 1, "notes": "space appeared behind first press"}]}},
        "player_roles": {"players": {"10": {"role": "advanced creator", "progression_route": "central pocket", "return_routes": ["central pocket"]}}},
    }
